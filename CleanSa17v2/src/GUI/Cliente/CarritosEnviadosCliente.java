...
public class CarritosEnviadosCliente extends BaseFrame implements Validador {
	...
	public CarritosEnviadosCliente(Cliente cliente) {
	...
	private void cargarTabla(Cliente cliente) {
		...
		List<Carrito> carritos = controller.mostrarCarritoporClienteEnviados(cliente.getId());
